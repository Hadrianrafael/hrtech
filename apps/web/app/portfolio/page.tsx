...
import { Button, Reveal, Container, Section, Breadcrumb, Tabs } from '@hrtech/ui';
  ...
  <div className="flex flex-wrap gap-x-8 gap-y-4">
    {stack.map((tech) => (
      <div key={tech.label} className="flex items-center gap-2.5">
        <tech.icon size={18} className="text-ink/45" />
      ...
      <Section className="border-t border-border">
        <Container>
          <Reveal className="max-w-xl">
            <span className="font-mono text-xs uppercase tracking-[0.2em] text-brand-orange">Demonstrações</span>
